...
export default function ProTip({ cocktail }: { cocktail: Cocktail }) {
	return (
		<fieldset className="mt-3 flex flex-col  rounded-md border border-border-secondary p-4 pb-2 shadow-sm">
			...
			<div className="-mt-2">
				{cocktail.proTips.map((proTip, index) => {
					return (
						<ul key={index} className="mb-2 flex items-baseline gap-x-2 text-sm text-text-primary lg:text-base">
